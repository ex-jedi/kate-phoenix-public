<?php
    ...
    try {
      ...
      $error = '<div class="notification notification-alert">' . PerchLang::get("%s. It could be that you haven't set a correct website URL in %s Settings %s (maybe, possibly)", $e->getMessage(), '<a href="' . PERCH_LOGINPATH . '/core/settings">', '</a>') . '</div>';
    }